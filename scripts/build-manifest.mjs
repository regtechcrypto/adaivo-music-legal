...
code{overflow-wrap:anywhere}@media(max-width:430px){header{align-items:flex-start;flex-direction:column}main{margin-block:1rem;padding:1.1rem}.cards{grid-template-columns:1fr}nav{font-size:.92rem}}
